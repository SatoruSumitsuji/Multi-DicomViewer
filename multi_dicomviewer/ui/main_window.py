...
class MainWindow(QMainWindow):
    ...
    def _build_shortcuts(self) -> None:
        ...
        for key, fn in (
            ...
            #   V    = ECG waveform show/hide
            #   L    = IVUS long-axis show/hide (IVUS only — no-op on XA)
            ...
            ("V", lambda: self._xa_toggle_ecg()),
            ("L", lambda: self._ivus_toggle_long_axis()),
    ...
    def _xa_toggle_ecg(self) -> None:
        """V = toggle the ECG waveform strip. The strip itself is built
    ...
    def _ivus_toggle_long_axis(self) -> None:
        """L = toggle the IVUS long-axis (longitudinal) view. No-op on
